...
int main() {
  ...
  basket.push_back(std::make_shared<Quote>("s1", 100, 10, .25));
  basket.push_back(std::make_shared<Quote>("s2", 120, 20, .25));
  basket.push_back(std::make_shared<Quote>("s3", 140, 30, .25));
  basket.push_back(std::make_shared<Quote>("s4", 160, 40, .25));
  int count = 0;
  for(auto i : basket)
